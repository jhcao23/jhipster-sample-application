...
import technology.touchmars.edu.service.UserCourseQueryService;
...
public class UserCourseResource {
    ...
    public ResponseEntity<List<UserCourse>> getAllUserCourses(UserCourseCriteria criteria, Pageable pageable) {
