...
describe('UserCourse Management Component', () => {
  let comp: UserCourseComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(UserCourseComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userCourses[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
