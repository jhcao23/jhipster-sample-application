...
class UserCourseResourceIT {
    ...
    public static UserCourse createEntity(EntityManager em) {
        ...
        // Add required entity
        Course course;
        course = em.insert(CourseResourceIT.createEntity(em)).block();
    ...
    public static UserCourse createUpdatedEntity(EntityManager em) {
        ...
        // Add required entity
        Course course;
        course = em.insert(CourseResourceIT.createUpdatedEntity(em)).block();
        userCourse.setCourse(course);
        return userCourse;
    }
    ...
    public static void deleteEntities(EntityManager em) {
        ...
        CourseResourceIT.deleteEntities(em);
    }
