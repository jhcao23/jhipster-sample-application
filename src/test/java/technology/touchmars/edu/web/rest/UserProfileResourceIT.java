...
class UserProfileResourceIT {
    ...
    void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getProfession()).isEqualTo(DEFAULT_PROFESSION);
        assertThat(testUserProfile.getIndustry()).isEqualTo(DEFAULT_INDUSTRY);
    }
    ...
    void getAllUserProfiles() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].profession")
            .value(hasItem(DEFAULT_PROFESSION))
            .jsonPath("$.[*].industry")
    ...
    void putNewUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getProfession()).isEqualTo(UPDATED_PROFESSION);
        assertThat(testUserProfile.getIndustry()).isEqualTo(UPDATED_INDUSTRY);
    }
